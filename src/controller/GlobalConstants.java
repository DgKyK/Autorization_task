...
public interface GlobalConstants {
    String INVITATION_MESSAGE = "invitation.string";
    String INPUT_MESSAGE = "input.string";
    String WRONG_INPUT = "wrong.input.string";
    String INPUT_NAME = "input.name.string";
    String INPUT_SURNAME = "input.surname.string";
